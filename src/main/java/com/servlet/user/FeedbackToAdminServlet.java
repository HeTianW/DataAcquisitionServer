...
@WebServlet(name = "FeedbackToAdminServlet", urlPatterns = "/user/feedbackToAdmin")
public class FeedbackToAdminServlet extends HttpServlet
{
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        if (result.containsKey("openid"))
        {
            ...
            info = userService.feedbackToAdmin(wechatId, comment);
